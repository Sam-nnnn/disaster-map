...
export function TaskDetailCard() {
  ...
  return (
    <div className="fixed inset-0 z-[2000] flex items-end sm:items-center justify-center sm:justify-end sm:pr-4 pointer-events-none bg-black/20 sm:bg-transparent transition-all">
      <div
        key={task.id}
        className="relative w-full h-[80vh] sm:h-auto sm:max-h-[85vh] sm:w-[380px] bg-white dark:bg-slate-900 sm:rounded-3xl rounded-t-3xl shadow-xl overflow-hidden animate-in slide-in-from-bottom-full sm:slide-in-from-right-8 duration-300 border border-slate-200 dark:border-slate-800 flex flex-col pointer-events-auto"
      >
        {/* Header */}
